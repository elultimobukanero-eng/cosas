...
b. Si se accede desde ADN Cliente, el cliente aparece ya identificado en cabecera.

VALIDACIONES DE CLIENTE KO → DETENER FLUJO Y SOLICITAR ACTUALIZACIÓN DE DATOS.  
SOLICITUD EN VUELO → ELIMINAR.

2. VALIDACIONES INICIALES DEL CLIENTE
...
b. Se selecciona ENVIAR POR CORREO.
c. Se completa email y persona de contacto.
d. Se marca la casilla de autorización.
e. Se pulsa ENVIAR.
f. Se visualiza modal “DOCUMENTO ENVIADO” y se pulsa ENTENDIDO.

4. PANTALLA PRINCIPAL DEL PRODUCTO
a. Se visualiza la ficha del producto “Vida Protección Empresa”.
b. Se pulsa CALCULAR PRECIO para iniciar el flujo de 10 pasos.
...
b. En el happy path, se pulsa CONTINUAR A CONTRATACIÓN.
...
a. Se muestran las modalidades de pago: anual, semestral, trimestral.
b. El importe anual es el mismo en todas.
c. Se selecciona la periodicidad acordada.
